...
async function handleAuthState(session) {
    ...
    if (currentUser) {
        ...
        userEmailLabel.textContent = currentUser.email || 'Usuário autenticado';

        setConnectionStatus('connected', 'Autenticado');
...
async function logoutUsuario() {
    try {
        ...
        showToast(`Erro ao sair: ${parseSupabaseError(error)}`, 'error');
    }
}
