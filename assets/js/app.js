...
async function handleAuthState(session) {
    currentUser = session?.user || DIRECT_ACCESS_USER;
    ...
    if (userEmailLabel) {
        userEmailLabel.textContent = currentUser.email || 'Acesso direto';
    }
...
async function logoutUsuario() {
    ...
    showToast('Acesso direto ativo. Login removido nesta versão.', 'warning');
}
